...
extends RandomStrollGoal {
    ...
    protected Vec3 m_7037_() {
        ...
        if (this.f_25725_.m_21536_() && this.f_25725_.m_20238_(Vec3.m_82512_((Vec3i)this.f_25725_.m_21534_())) > (double)(this.f_25725_.m_21535_() * this.f_25725_.m_21535_())) {
            return DefaultRandomPos.m_148412_((PathfinderMob)this.f_25725_, (int)this.xzSpread, (int)3, (Vec3)Vec3.m_82539_((Vec3i)this.f_25725_.m_21534_()), (double)3.0);
        }
        if (this.f_25725_.m_217043_().m_188501_() < 0.3f && (vector3d = this.findSurfaceTarget(this.f_25725_, this.xzSpread, this.ySpread * 2)) != null) {
            return vector3d;
        }
        vector3d = DefaultRandomPos.m_148403_((PathfinderMob)this.f_25725_, (int)this.xzSpread, (int)this.ySpread);
        int i = 0;
        while (vector3d != null && !this.f_25725_.m_9236_().m_8055_(AMBlockPos.fromVec3(vector3d)).m_60647_((BlockGetter)this.f_25725_.m_9236_(), AMBlockPos.fromVec3(vector3d), PathComputationType.WATER) && i++ < 15) {
            vector3d = DefaultRandomPos.m_148403_((PathfinderMob)this.f_25725_, (int)10, (int)this.ySpread);
        }

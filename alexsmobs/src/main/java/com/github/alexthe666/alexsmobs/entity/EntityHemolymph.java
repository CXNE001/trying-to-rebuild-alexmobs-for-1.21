...
public class EntityHemolymph
extends Entity {
    private UUID ownerUUID;
    private int ownerNetworkId;
    private boolean leftOwner;

    public EntityHemolymph(EntityType p_i50162_1_, Level p_i50162_2_) {
        super(p_i50162_1_, p_i50162_2_);
    }

    public EntityHemolymph(Level worldIn, EntityWarpedMosco p_i47273_2_) {
        this((EntityType)AMEntityRegistry.HEMOLYMPH.get(), worldIn);
    ...
    public EntityHemolymph(PlayMessages.SpawnEntity spawnEntity, Level world) {
        this((EntityType)AMEntityRegistry.HEMOLYMPH.get(), world);
    }
    ...
    public void m_8119_() {
        ...
        if (this.m_9236_().f_46443_) {
            ...
            this.m_9236_().m_7106_((ParticleOptions)AMParticleRegistry.HEMOLYMPH.get(), this.m_20185_() + (double)r1, this.m_20186_() + (double)r2, this.m_20189_() + (double)r3, (double)(r1 * 0.1f), (double)(r2 * 0.1f), (double)(r3 * 0.1f));
        }
        super.m_8119_();
    ...
    protected void onEntityHit(EntityHitResult p_213868_1_) {
        ...
        if (entity instanceof LivingEntity) {
            p_213868_1_.m_82443_().m_6469_(this.m_269291_().m_269299_((Entity)this, (LivingEntity)entity), 7.0f);
        }
    }
    ...
    protected void updateRotation() {
        Vec3 vector3d = this.m_20184_();
        float f = Mth.m_14116_((float)((float)(vector3d.f_82479_ * vector3d.f_82479_ + vector3d.f_82481_ * vector3d.f_82481_)));
        this.m_146926_(EntityHemolymph.lerpRotation(this.f_19860_, (float)(Mth.m_14136_((double)vector3d.f_82480_, (double)f) * 57.2957763671875)));
        this.m_146922_(EntityHemolymph.lerpRotation(this.f_19859_, (float)(Mth.m_14136_((double)vector3d.f_82479_, (double)vector3d.f_82481_) * 57.2957763671875)));
    }
}

...
extends Entity {
    ...
    public EntityVineLasso(Level worldIn, LivingEntity entity) {
        ...
        this.setShooter((Entity)entity);
        this.m_6034_(entity.m_20185_(), entity.m_20188_() + (double)0.15f, entity.m_20189_());
    }
    ...
    protected void onEntityHit(EntityHitResult p_213868_1_) {
        ...
        if (entity instanceof LivingEntity && p_213868_1_.m_82443_() != this.getOwner() && p_213868_1_.m_82443_() instanceof LivingEntity && !VineLassoUtil.hasLassoData((LivingEntity)p_213868_1_.m_82443_())) {
    ...
    protected void updateRotation() {
        Vec3 vector3d = this.m_20184_();
        float f = Mth.m_14116_((float)((float)(vector3d.f_82479_ * vector3d.f_82479_ + vector3d.f_82481_ * vector3d.f_82481_)));
        this.m_146926_(EntityVineLasso.lerpRotation(this.f_19860_, (float)(Mth.m_14136_((double)vector3d.f_82480_, (double)f) * 57.2957763671875)));

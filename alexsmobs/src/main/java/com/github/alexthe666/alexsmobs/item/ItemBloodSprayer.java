...
extends Item {
    ...
    public int m_8105_(ItemStack stack) {
        return ItemBloodSprayer.isUsable(stack) ? Integer.MAX_VALUE : 0;
    }
    ...
    public InteractionResultHolder<ItemStack> m_7203_(Level worldIn, Player playerIn, InteractionHand handIn) {
        ...
        if (!ItemBloodSprayer.isUsable(itemstack)) {
    ...
    public ItemStack findAmmo(Player entity) {
        ...
        for (int i = 0; i < entity.m_150109_().m_6643_(); ++i) {
            ...
            if (!IS_BLOOD.test(itemstack1)) continue;
            return itemstack1;
        }
        return ItemStack.f_41583_;
    }
    ...
    public boolean m_142522_(ItemStack itemStack) {
        return super.m_142522_(itemStack) && ItemBloodSprayer.isUsable(itemStack);
    }

    public void m_5929_(Level worldIn, LivingEntity livingEntityIn, ItemStack stack, int count) {
        if (ItemBloodSprayer.isUsable(stack)) {
            if (count % 2 == 0) {
                boolean left = false;

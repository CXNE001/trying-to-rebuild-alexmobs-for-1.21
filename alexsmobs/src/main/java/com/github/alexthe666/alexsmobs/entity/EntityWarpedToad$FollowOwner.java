...
public static class EntityWarpedToad.FollowOwner
extends Goal {
    ...
    public EntityWarpedToad.FollowOwner(EntityWarpedToad p_i225711_1_, double p_i225711_2_, float p_i225711_4_, float p_i225711_5_, boolean p_i225711_6_) {

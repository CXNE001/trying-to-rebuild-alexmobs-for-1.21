...
public class BoneSerpentAIMeleeJump
extends JumpGoal {
    ...
    public void m_8037_() {
        ...
        if ((target = this.dolphin.m_5448_()) != null && this.dolphin.m_20270_((Entity)target) < 3.0f && this.attackCooldown <= 0) {
            this.dolphin.m_7327_((Entity)target);

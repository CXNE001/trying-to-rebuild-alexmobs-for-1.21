...
public class BoneSerpentAIJump
extends JumpGoal {
    ...
    public boolean m_8036_() {
        if (this.dolphin.m_217043_().m_188503_(this.interval) != 0 || this.dolphin.m_5448_() != null) {
            return false;
        }
    ...
    private boolean canJumpTo(BlockPos pos, int dx, int dz, int scale) {
        ...
        return (this.dolphin.m_9236_().m_6425_(blockpos).m_205070_(FluidTags.f_13131_) || this.dolphin.m_9236_().m_6425_(blockpos).m_205070_(FluidTags.f_13132_)) && !this.dolphin.m_9236_().m_8055_(blockpos).m_280555_();
    }
    ...
    public void m_8037_() {
        ...
        if (!flag) {
            ...
            boolean bl = this.inWater = fluidstate.m_205070_(FluidTags.f_13132_) || fluidstate.m_205070_(FluidTags.f_13131_);
        }

...
extends Entity {
    ...
    public EntityIceShard(Level worldIn, EntityFroststalker stalker) {
        this((EntityType)AMEntityRegistry.ICE_SHARD.get(), worldIn);
        this.setShooter((Entity)stalker);
        this.m_6034_(stalker.m_20208_(0.5), stalker.m_20188_() + (double)0.1f, stalker.m_20262_(0.5));
    }
    ...
    public EntityIceShard(PlayMessages.SpawnEntity spawnEntity, Level world) {
        this((EntityType)AMEntityRegistry.ICE_SHARD.get(), world);
    }
    ...
    public void m_8119_() {
        ...
        if (this.m_9236_().f_46443_ && this.f_19796_.m_188503_(2) == 0) {
            ...
            this.m_9236_().m_7106_((ParticleOptions)ParticleTypes.f_175821_, this.m_20185_() + (double)r1, this.m_20186_() + (double)r2, this.m_20189_() + (double)r3, (double)(r1 * 0.1f), (double)(r2 * 0.1f), (double)(r3 * 0.1f));
        }
        super.m_8119_();
    ...
    protected void onEntityHit(EntityHitResult p_213868_1_) {
        ...
        if (entity instanceof LivingEntity && p_213868_1_.m_82443_() != this.getOwner() && !(p_213868_1_.m_82443_() instanceof EntityFroststalker)) {
            p_213868_1_.m_82443_().m_6469_(this.m_269291_().m_269299_((Entity)this, (LivingEntity)entity), 2.0f + this.f_19796_.m_188501_() * 3.0f);
        }
    }
    ...
    public void shootFromRotation(Entity p_234612_1_, float p_234612_2_, float p_234612_3_, float p_234612_4_, float p_234612_5_, float p_234612_6_) {
        float f0 = p_234612_3_ * ((float)Math.PI / 180);
        float f = -Mth.m_14031_((float)f0) * Mth.m_14089_((float)(p_234612_2_ * ((float)Math.PI / 180)));
        float f1 = -Mth.m_14031_((float)((p_234612_2_ + p_234612_4_) * ((float)Math.PI / 180)));
        float f2 = Mth.m_14089_((float)f0) * Mth.m_14089_((float)(p_234612_2_ * ((float)Math.PI / 180)));
    ...
    protected void updateRotation() {
        Vec3 vector3d = this.m_20184_();
        float f = Mth.m_14116_((float)((float)(vector3d.f_82479_ * vector3d.f_82479_ + vector3d.f_82481_ * vector3d.f_82481_)));
        this.m_146926_(EntityIceShard.lerpRotation(this.f_19860_, (float)(Mth.m_14136_((double)vector3d.f_82480_, (double)f) * 57.2957763671875)));
        this.m_146922_(EntityIceShard.lerpRotation(this.f_19859_, (float)(Mth.m_14136_((double)vector3d.f_82479_, (double)vector3d.f_82481_) * 57.2957763671875)));
    }
}

...
public class AnimalAILeaveWater
extends Goal {
    ...
    public boolean m_8036_() {
        if (this.creature.m_9236_().m_6425_(this.creature.m_20183_()).m_205070_(FluidTags.f_13131_) && (this.creature.m_5448_() != null || this.creature.m_217043_().m_188503_(30) == 0) && this.creature instanceof ISemiAquatic && ((ISemiAquatic)this.creature).shouldLeaveWater()) {
    ...
    public boolean m_8045_() {
        ...
        return !this.creature.m_21573_().m_26571_() && this.targetPos != null && !this.creature.m_9236_().m_6425_(this.targetPos).m_205070_(FluidTags.f_13131_);
    }
    ...
    public BlockPos generateTarget() {
        ...
        for (int tries = 0; vector3d != null && tries < 8; ++tries) {
            ...
            for (BlockPos blockpos1 : BlockPos.m_121976_((int)Mth.m_14107_((double)(vector3d.f_82479_ - 2.0)), (int)Mth.m_14107_((double)(vector3d.f_82480_ - 1.0)), (int)Mth.m_14107_((double)(vector3d.f_82481_ - 2.0)), (int)Mth.m_14107_((double)(vector3d.f_82479_ + 2.0)), (int)Mth.m_14107_((double)vector3d.f_82480_), (int)Mth.m_14107_((double)(vector3d.f_82481_ + 2.0)))) {
                if (!this.creature.m_9236_().m_6425_(blockpos1).m_205070_(FluidTags.f_13131_)) continue;
                waterDetected = true;
                break;
            }
            if (!waterDetected) {

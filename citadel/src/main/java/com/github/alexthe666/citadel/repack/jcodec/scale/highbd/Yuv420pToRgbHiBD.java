    ...
    public final void transform(PictureHiBD src, PictureHiBD dst) {
        ...
        for (int i = 0; i < dst.getHeight() >> 1; ++i) {
            for (int k = 0; k < dst.getWidth() >> 1; ++k) {
                int j2 = k << 1;
                Yuv422pToRgbHiBD.YUV444toRGB888(y[offLuma + j2] << this.upShift >> this.downShift, u[offChroma] << this.upShift >> this.downShift, v[offChroma] << this.upShift >> this.downShift, data, (offLuma + j2) * 3);
                Yuv422pToRgbHiBD.YUV444toRGB888(y[offLuma + j2 + 1] << this.upShift >> this.downShift, u[offChroma] << this.upShift >> this.downShift, v[offChroma] << this.upShift >> this.downShift, data, (offLuma + j2 + 1) * 3);
                Yuv422pToRgbHiBD.YUV444toRGB888(y[offLuma + j2 + stride] << this.upShift >> this.downShift, u[offChroma] << this.upShift >> this.downShift, v[offChroma] << this.upShift >> this.downShift, data, (offLuma + j2 + stride) * 3);
                Yuv422pToRgbHiBD.YUV444toRGB888(y[offLuma + j2 + stride + 1] << this.upShift >> this.downShift, u[offChroma] << this.upShift >> this.downShift, v[offChroma] << this.upShift >> this.downShift, data, (offLuma + j2 + stride + 1) * 3);
                ++offChroma;
            }
            if ((dst.getWidth() & 1) != 0) {
                j = dst.getWidth() - 1;
        ...
        if ((dst.getHeight() & 1) != 0) {
            ...
            if ((dst.getWidth() & 1) != 0) {
                ...
                Yuv422pToRgbHiBD.YUV444toRGB888(y[offLuma + j3] << this.upShift >> this.downShift, u[offChroma] << this.upShift >> this.downShift, v[offChroma] << this.upShift >> this.downShift, data, (offLuma + j3) * 3);
                ++offChroma;
            }
        }
    }

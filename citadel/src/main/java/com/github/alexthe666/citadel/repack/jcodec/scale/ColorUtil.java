...
import com.github.alexthe666.citadel.repack.jcodec.scale.RgbToYuv420j;
import com.github.alexthe666.citadel.repack.jcodec.scale.RgbToYuv420p;
import com.github.alexthe666.citadel.repack.jcodec.scale.RgbToYuv422p;
import com.github.alexthe666.citadel.repack.jcodec.scale.Transform;
import com.github.alexthe666.citadel.repack.jcodec.scale.Yuv420jToRgb;
import com.github.alexthe666.citadel.repack.jcodec.scale.Yuv420pToRgb;
import com.github.alexthe666.citadel.repack.jcodec.scale.Yuv420pToYuv422p;
import com.github.alexthe666.citadel.repack.jcodec.scale.Yuv422pToRgb;
import com.github.alexthe666.citadel.repack.jcodec.scale.Yuv422pToYuv420p;
import com.github.alexthe666.citadel.repack.jcodec.scale.Yuv444jToYuv420j;
...
public class ColorUtil {
    ...
    static {
        HashMap<ColorSpace, Transform> rgb = new HashMap<ColorSpace, Transform>();
        ...
        HashMap<ColorSpace, Transform> yuv420 = new HashMap<ColorSpace, Transform>();
        ...
        HashMap<ColorSpace, Transform> yuv422 = new HashMap<ColorSpace, Transform>();
        ...
        HashMap<ColorSpace, Idential> yuv444 = new HashMap<ColorSpace, Idential>();
        yuv444.put(ColorSpace.YUV444, new Idential());
        map.put(ColorSpace.YUV444, yuv444);
        HashMap<ColorSpace, Transform> yuv444j = new HashMap<ColorSpace, Transform>();
        ...
        HashMap<ColorSpace, Transform> yuv420j = new HashMap<ColorSpace, Transform>();

...
public class VP8DCT {
    ...
    public static int[] decodeDCT(int[] input) {
        ...
        for (i = 0; i < 4; ++i) {
            ...
            temp1 = output[offset * 4 + 1] * 35468 >> 16;
    ...
    public static int[] encodeWHT(int[] input) {
        ...
        for (i = 0; i < 4; ++i) {
            ...
            output[outputOffset + 4] = (b2 += b2 < 0 ? 1 : 0) + 3 >> 3;
            output[outputOffset + 8] = (c2 += c2 < 0 ? 1 : 0) + 3 >> 3;
            output[outputOffset + 12] = (d2 += n) + 3 >> 3;
            ++inputOffset;
            ++outputOffset;
        }
        return output;

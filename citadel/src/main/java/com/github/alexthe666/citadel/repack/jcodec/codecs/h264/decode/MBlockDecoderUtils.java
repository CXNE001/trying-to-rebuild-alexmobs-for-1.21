...
public class MBlockDecoderUtils {
    ...
    public static final int NULL_VECTOR;
    ...
    public static void saveVectIntra(DecoderState sharedState, int mbX) {
        ...
        MBlockDecoderUtils.saveVect(sharedState.mvTop, 0, xx, xx + 4, NULL_VECTOR);
        MBlockDecoderUtils.saveVect(sharedState.mvLeft, 0, 0, 4, NULL_VECTOR);
        MBlockDecoderUtils.saveVect(sharedState.mvTop, 1, xx, xx + 4, NULL_VECTOR);
        MBlockDecoderUtils.saveVect(sharedState.mvLeft, 1, 0, 4, NULL_VECTOR);
    }

    static {
        NULL_VECTOR = H264Utils.Mv.packMv(0, 0, -1);
    }
}

...
extends BasicModelPart {
    ...
    public void render(PoseStack p_228309_1_, VertexConsumer p_228309_2_, int p_228309_3_, int p_228309_4_, float p_228309_5_, float p_228309_6_, float p_228309_7_, float p_228309_8_) {
        if (!(!this.showModel || this.cubeList.isEmpty() && this.childModels.isEmpty())) {
            ...
            if (!this.scaleChildren) {
                p_228309_1_.m_85841_(1.0f / Math.max(this.scaleX, 1.0E-4f), 1.0f / Math.max(this.scaleY, 1.0E-4f), 1.0f / Math.max(this.scaleZ, 1.0E-4f));
            }
            while (var9.hasNext()) {
    ...
    private void doRender(PoseStack.Pose p_228306_1_, VertexConsumer p_228306_2_, int p_228306_3_, int p_228306_4_, float p_228306_5_, float p_228306_6_, float p_228306_7_, float p_228306_8_) {
        Matrix4f lvt_9_1_ = p_228306_1_.m_252922_();
        Matrix3f lvt_10_1_ = p_228306_1_.m_252943_();
        for (TabulaModelRenderUtils.ModelBox lvt_12_1_ : this.cubeList) {
            for (TabulaModelRenderUtils.TexturedQuad lvt_16_1_ : lvt_12_1_.quads) {
                Vector3f lvt_17_1_ = new Vector3f((Vector3fc)lvt_16_1_.normal);
                lvt_17_1_.mul((Matrix3fc)lvt_10_1_);
                ...
                for (int lvt_21_1_ = 0; lvt_21_1_ < 4; ++lvt_21_1_) {
                    ...
                    lvt_26_1_.mul((Matrix4fc)lvt_9_1_);
                    p_228306_2_.m_5954_(lvt_26_1_.x(), lvt_26_1_.y(), lvt_26_1_.z(), p_228306_5_, p_228306_6_, p_228306_7_, p_228306_8_, lvt_22_1_.textureU, lvt_22_1_.textureV, p_228306_4_, p_228306_3_, lvt_18_1_, lvt_19_1_, lvt_20_1_);
                }
            }
        }
    }

...
public final class ChannelLayout {
    private static final List<ChannelLayout> _values = new ArrayList<ChannelLayout>();
    ...
    public static final ChannelLayout kCAFChannelLayoutTag_StereoHeadphones = new ChannelLayout(0x660002, new Label[]{Label.HeadphonesLeft, Label.HeadphonesRight});
    ...
    public static final ChannelLayout kCAFChannelLayoutTag_Hexagonal = new ChannelLayout(0x6E0006, new Label[]{Label.Left, Label.Right, Label.LeftSurround, Label.RightSurround, Label.Center, Label.CenterSurround});
    ...
    public static final ChannelLayout kCAFChannelLayoutTag_Cube = new ChannelLayout(0x700008, new Label[]{Label.Left, Label.Right, Label.LeftSurround, Label.RightSurround, Label.TopBackLeft, Label.TopBackRight, Label.TopBackCenter, Label.TopCenterSurround});
    ...
    public static final ChannelLayout kCAFChannelLayoutTag_MPEG_4_0_B = new ChannelLayout(0x740004, new Label[]{Label.Center, Label.Left, Label.Right, Label.CenterSurround});
    public static final ChannelLayout kCAFChannelLayoutTag_MPEG_5_0_A = new ChannelLayout(0x750005, new Label[]{Label.Left, Label.Right, Label.Center, Label.LeftSurround, Label.RightSurround});
    ...
    public static final ChannelLayout kCAFChannelLayoutTag_MPEG_5_0_C = new ChannelLayout(0x770005, new Label[]{Label.Left, Label.Center, Label.Right, Label.LeftSurround, Label.RightSurround});
    ...
    public static final ChannelLayout kCAFChannelLayoutTag_MPEG_6_1_A = new ChannelLayout(0x7D0007, new Label[]{Label.Left, Label.Right, Label.Center, Label.LFEScreen, Label.LeftSurround, Label.RightSurround, Label.Right});
    ...
    public static final ChannelLayout kCAFChannelLayoutTag_MPEG_7_1_C = new ChannelLayout(0x800008, new Label[]{Label.Left, Label.Right, Label.Center, Label.LFEScreen, Label.LeftSurround, Label.RightSurround, Label.RearSurroundLeft, Label.RearSurroundRight});
    public static final ChannelLayout kCAFChannelLayoutTag_Emagic_Default_7_1 = new ChannelLayout(0x810008, new Label[]{Label.Left, Label.Right, Label.LeftSurround, Label.RightSurround, Label.Center, Label.LFEScreen, Label.LeftCenter, Label.RightCenter});
    public static final ChannelLayout kCAFChannelLayoutTag_SMPTE_DTV = new ChannelLayout(0x820008, new Label[]{Label.Left, Label.Right, Label.Center, Label.LFEScreen, Label.LeftSurround, Label.RightSurround, Label.LeftTotal, Label.RightTotal});
    public static final ChannelLayout kCAFChannelLayoutTag_ITU_2_1 = new ChannelLayout(0x830003, new Label[]{Label.Left, Label.Right, Label.CenterSurround});
    public static final ChannelLayout kCAFChannelLayoutTag_ITU_2_2 = new ChannelLayout(0x840004, new Label[]{Label.Left, Label.Right, Label.LeftSurround, Label.RightSurround});
    ...
    public static final ChannelLayout kCAFChannelLayoutTag_DVD_10 = new ChannelLayout(0x880004, new Label[]{Label.Left, Label.Right, Label.Center, Label.LFEScreen});
    ...
    public static final ChannelLayout kCAFChannelLayoutTag_AAC_Octagonal = new ChannelLayout(0x900008, new Label[]{Label.Center, Label.Left, Label.Right, Label.LeftSurround, Label.RightSurround, Label.RearSurroundLeft, Label.RearSurroundRight, Label.CenterSurround});
    public static final ChannelLayout kCAFChannelLayoutTag_TMH_10_2_std = new ChannelLayout(0x910010, new Label[]{Label.Left, Label.Right, Label.Center, Label.Mono, Label.Mono, Label.Mono, Label.LeftSurround, Label.RightSurround, Label.Mono, Label.Mono, Label.Mono, Label.Mono, Label.Mono, Label.CenterSurround, Label.LFEScreen, Label.LFE2});
    ...
    public static final ChannelLayout kCAFChannelLayoutTag_RESERVED_DO_NOT_USE = new ChannelLayout(0x930000, new Label[0]);
    private int code;

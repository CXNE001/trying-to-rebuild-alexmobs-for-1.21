...
import com.github.alexthe666.citadel.repack.jcodec.common.tools.ToJSON;
import java.io.File;
...
public class Platform {
    ...
    private static final Map<Class, Class> boxed2primitive = new HashMap<Class, Class>();

    public static <T> T newInstance(Class<T> clazz, Object[] params) {
        try {
            return clazz.getConstructor(Platform.classes(params)).newInstance(params);
        }
        catch (Exception e) {
    ...
    public static byte[] getBytes(String fourcc) {
        try {
            return fourcc.getBytes(ISO8859_1);
        }

...
extends MBlockDecoderBase {
    ...
    public void decode(MBlock mBlock, Picture mb, Frame[][] references) {
        ...
        int qp1 = MBlockDecoderBDirect.calcQpChroma(this.s.qp, this.s.chromaQpOffset[0]);
        int qp2 = MBlockDecoderBDirect.calcQpChroma(this.s.qp, this.s.chromaQpOffset[1]);

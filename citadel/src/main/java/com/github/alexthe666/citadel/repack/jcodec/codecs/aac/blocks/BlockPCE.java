...
import com.github.alexthe666.citadel.repack.jcodec.codecs.aac.blocks.RawDataBlockType;
...
extends Block {
    ...
    public void parse(BitReader _in) {
        ...
        this.decodeChannelMap(layout_map, tags += num_side, ChannelPosition.AAC_CHANNEL_BACK, _in, num_back);
        this.decodeChannelMap(layout_map, tags += num_back, ChannelPosition.AAC_CHANNEL_LFE, _in, num_lfe);
        _in.skip(4 * num_assoc_data);
        this.decodeChannelMap(layout_map, tags += num_lfe, ChannelPosition.AAC_CHANNEL_CC, _in, num_cc);
        tags += num_cc;
        _in.align();

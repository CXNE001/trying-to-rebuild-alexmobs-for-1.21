...
public class BlockInterpolator {
    ...
    private LumaInterpolator[] safe = this.initSafe();
    private LumaInterpolator[] unsafe = this.initUnsafe();
    ...
    private LumaInterpolator[] initSafe() {
        ...
        return new LumaInterpolator[]{new LumaInterpolator(){
    ...
    private static interface LumaInterpolator {
        public void getLuma(byte[] var1, int var2, int var3, byte[] var4, int var5, int var6, int var7, int var8, int var9, int var10);
    }
}

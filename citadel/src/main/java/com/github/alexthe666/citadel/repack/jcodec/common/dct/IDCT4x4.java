...
public class IDCT4x4 {
    ...
    public static final int C1 = IDCT4x4.C_FIX(0.6532814824);
    public static final int C2 = IDCT4x4.C_FIX(0.2705980501);
    public static final int C3 = IDCT4x4.C_FIX(0.5);
    public static final int C_SHIFT = 18;
    public static final int RN_SHIFT = 15;
    public static final int R1 = IDCT4x4.R_FIX(0.6532814824);
    public static final int R2 = IDCT4x4.R_FIX(0.2705980501);
    public static final int R3 = IDCT4x4.R_FIX(0.5);

...
import com.github.alexthe666.citadel.repack.jcodec.codecs.mpeg4.MPEG4BiRenderer;
import com.github.alexthe666.citadel.repack.jcodec.codecs.mpeg4.MPEG4Bitstream;
import com.github.alexthe666.citadel.repack.jcodec.codecs.mpeg4.MPEG4DecodingContext;
import com.github.alexthe666.citadel.repack.jcodec.codecs.mpeg4.MPEG4Renderer;
...
extends VideoDecoder {
    ...
    public Picture decodeFrame(ByteBuffer data, byte[][] buffer) {
        ...
        this.ctx.intraDCThreshold = 0;
        this.ctx.fcodeBackward = 0;
        this.ctx.fcodeForward = 0;
    ...
    public static void putPix(Picture p, Macroblock mb, int x, int y) {
        ...
        for (int pl = 1; pl < 3; ++pl) {
            ...
            while (row2 < 8) {
                int col = 0;
                while (col < 8) {
                    plane[dsto + col] = mb.pred[pl][srco2];
                    ++col;
                    ++srco2;
                }
                ++row2;

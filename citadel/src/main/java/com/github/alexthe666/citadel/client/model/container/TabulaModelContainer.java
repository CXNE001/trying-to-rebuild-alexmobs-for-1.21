...
import com.github.alexthe666.citadel.client.model.container.TabulaAnimationContainer;
...
public class TabulaModelContainer {
    ...
    private List<TabulaCubeContainer> cubes = new ArrayList<TabulaCubeContainer>();
    private final List<TabulaAnimationContainer> anims = new ArrayList<TabulaAnimationContainer>();
